...
if ($("#radial_chart").length) {
    options = {
        ...
        colors: ["#333231", "#00a7e1", "#f1b44c", "#3ddc97"]
    };
...
if ($("#pie_chart").length) {
    options = {
        ...
        colors: ["#333231", "#3ddc97", "#e4cc37", "#f06543", "#eff2f7"],
        legend: {
            show: !0,
            position: "bottom",
...
if ($("#donut_chart").length) {
    ...
    options = {
        ...
        series: [44, 55, 41, 17, 15],
        labels: ["Series 1", "Series 2", "Series 3", "Series 4", "Series 5"],
        colors: ["#333231", "#00a7e1", "#3ddc97", "#f06543", "#eff2f7"],
        legend: {
            show: !0,
            position: "bottom",
            horizontalAlign: "center",
