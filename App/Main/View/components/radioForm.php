    ...
    <div class="col-md-9">
        ...
        <?php $rnd = "ID".rand(1111,9999);  ?>
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input <?php echo $data->content === $item ? "checked" : null ; ?> <?php echo $data->required === "active" ? "required" : null; ?>  type="radio" id="<?php echo $rnd; ?>" name="<?php echo $data->name; ?>" value="<?php echo $item; ?>" class="custom-control-input">
