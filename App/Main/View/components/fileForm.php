...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <div class="row">
            ...
            <div class="col-md-12">
                <textarea style="display: none; font-size: 11px;line-height: 24px; height: 37px;" readonly id="<?php echo $rnd; ?>"  name="<?php echo $data->name; ?>"  <?php echo $data->required === "active" ? "required" : null; ?>  class="form-control imgContentZone" type="text" placeholder="<?php echo $data->placeholder; ?>" ></textarea>


                <div class="imgViews <?php echo $rnd; ?>"></div>
