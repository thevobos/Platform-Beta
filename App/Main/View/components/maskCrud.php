    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mt-3 mr-sm-2">
                        <input type="text" required  class="form-control mb-2" name="placeholder[]"  placeholder="Input Placeholder">
                    </div>
                </div>

                <div class="col-md-3">
                    <div class="mt-3 mr-sm-2">
                        <input type="text" required  class="form-control mb-2" name="child[]"  placeholder="Veri Şablonu">
                    </div>
                </div>
                ...
                <input type="hidden" name="component[]" value="MASK">
