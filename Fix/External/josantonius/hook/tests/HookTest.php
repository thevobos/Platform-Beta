...
final class HookTest extends TestCase
{
    ...
    public function testAddAction()
    {
        ...
        $this->assertTrue(
            $hook::add_action('css', ['Josantonius\Hook\Example', 'css'])
        );
    }
    ...
    public function testAddActionWithPriority()
    {
        ...
        $this->assertTrue(
            $hook::add_action('js', ['Josantonius\Hook\Example', 'js'], 1)
        );
    }
    ...
    public function testAddActionWithPriorityAndArguments()
    {
        ...
        $this->assertTrue(
            $hook::add_action('meta', [$instance, 'meta'], 2, 1)
        );
    }
    ...
    public function testAddActionWithCustomSingletonMethod()
    {
        ...
        $this->assertTrue(
            $hook::add_action('article', [$instance, 'article'], 3, 0)
        );
    }
