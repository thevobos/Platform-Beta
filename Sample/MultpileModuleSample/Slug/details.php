...
$getBlogArticles = cms::getRecordWithSlug("2742-17606-7313-90168",$_GET["slug"] ?? "");

if($getBlogArticles->status !== "success"){
...
<head>
    <meta charset="UTF-8">
    <title><?php echo $getBlogArticles->data->title; ?></title>
...
<div class="container">
    <div class="header"><?php echo $getBlogArticles->data->title; ?></div>
    <div class="item">
        <div class="cover">
            <img src="<?php echo $getBlogArticles->data->cover; ?>" alt="">
        </div>
        <div class="content">
            <p><?php echo $getBlogArticles->data->content; ?></p>
        </div>
    </div>
</div>
