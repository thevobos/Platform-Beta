...
if(!isset($_SESSION["cms_login"]) or !isset($_SESSION["cms_auth_site"]) or !isset($_SESSION["cms_auth_assets"])){
    exit(die(header("HTTP/1.1 505 Not Found")));
}
...
$config = array(
    ...
    |
    */
    'base_url' => $_SESSION['cms_auth_assets']."/Upload/",
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'upload_dir' => ($_SESSION["cms_auth_manager"] ? "static" : $_SESSION["cms_auth_site"]).'/original/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../Upload/'.($_SESSION["cms_auth_manager"] ? "static" : $_SESSION["cms_auth_site"]).'/original/',
    ...
    |
    */
    'thumbs_base_path' => '../../Upload/'.($_SESSION["cms_auth_manager"] ? "static" : $_SESSION["cms_auth_site"]).'/thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => 'Upload/'.($_SESSION["cms_auth_manager"] ? "static" : $_SESSION["cms_auth_site"]).'/thumbs/',
    ...
    */
    ...
    'ext_file'                                => array( 'doc', 'docx', 'pdf', 'xlsx', 'txt', 'csv', 'psd', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp' ), //Files
